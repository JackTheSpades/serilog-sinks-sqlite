...
namespace Serilog
{
    ...
    public static class LoggerConfigurationSQLiteExtensions
    {
        ...
        /// <param name="columns">The columns and content configuration to be used in the SQLite database.</param>
        ...
        public static LoggerConfiguration SQLite(
            ...
            SQLiteColumnCollection columns = null,
            ...
            bool rollOver = true)
        {
            ...
            if (columns is null)
                columns = SQLiteColumnCollection.DefaultCollection();

            if (retentionPeriod.HasValue && !columns.HasTimestampColumn)
                columns.Add(new TimestampSQLiteColumn());
